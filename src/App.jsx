  ...
  return (
    <Router>
      <Routes>
        ...
        {/* TRAINER */}
        <Route path='/trainer/login' element={trainer?.token !== null ? <Navigate to='/trainer/dashboard' /> : <TrainerLogin />} />
        <Route path='/trainer/*' element={<TrainerRoute />} />

        {/* ADMIN */}
        <Route path='/admin/login' element={admin?.token !== null ? <Navigate to='/admin/dashboard' /> : <AdminLogin />} />
