            ...
            <section className="w-full h-auto relative overflow-x-hidden">
                <main className="w-full lg:h-screen h-screen relative bg-zinc-900 overflow-x-hidden " style={backgroundStyle} >
                    ...
                    <div className="w-full h-full absolute bg-black bg-opacity-75 flex flex-col items-center justify-center px-4 overflow-x-hidden">
                        ...
                        {token ? (<button onClick={() => handleBooking()} type="button" className="hover:scale-[1.05] mt-10 text-white bg-[#050708] w3-animate-zoom hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-normal rounded-lg text- px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 mr-2 mb-2">
                            Buy This Plan
