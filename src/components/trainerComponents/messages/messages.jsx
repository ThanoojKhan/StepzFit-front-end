          ...
          <div className="flex sm:flex sm:flex-col py-8 pl-6 overflow-x-scroll sm:overflow-y-scroll pr-2 gap-2 sm:w-64 bg-white flex-shrink-0">
            {trainee.length !== 0 && (
              trainee.map((trainee, index) => (
                trainee._id ? (
                  <div key={index} onClick={() => loadChat(userId, trainee._id)} className="flex flex-col items-center bg-indigo-100 border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg cursor-pointer hover:bg-indigo-200">
            ...
            {admin?._id && (
              <div onClick={() => loadChat(userId, admin._id)} className="flex flex-col items-center bg-indigo-100 border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg hover:bg-indigo-200">
                <div className="h-20 w-20 rounded-full border overflow-hidden">
                  <img
