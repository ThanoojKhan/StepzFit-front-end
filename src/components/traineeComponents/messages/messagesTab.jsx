            ...
            <div className="flex h-screen antialiased text-gray-800">
                <div className="sm:flex sm:flex-row h-full w-full overflow-x-hidden">
                    <div className="flex sm:flex sm:flex-col py-8 pl-6 overflow-x-scroll sm:overflow-y-scroll pr-2 gap-2 sm:w-64 bg-white flex-shrink-0">
                        {trainer?._id ?
                            <div onClick={() => loadChat(userId, trainer._id)} className="flex flex-col items-center bg-indigo-100 border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg">
                                <div className="h-20 w-20 rounded-full border overflow-hidden">
                                    <img
                                        src={trainer?.profileImage ? trainer?.profileImage : 'https://www.kreedon.com/wp-content/uploads/2022/07/certified_personal_trainer_mobile_hero_image_2x-696x427.jpg'}
                                        alt="Avatar"
                        ...
                        {admin?._id ?
                            <div onClick={() => loadChat(userId, admin._id)} className="flex flex-col items-center bg-indigo-100 border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg">
                                <div className="h-20 w-20 rounded-full border overflow-hidden">
                                    <img
                                            ...
                                            {(message?.sender?._id || message?.sender) == userId ? <div className="col-start-7 col-end-13 p-3 rounded-lg">
                                                <div className="flex items-center justify-start flex-row-reverse">
                                                    <div className="flex items-center justify-center h-10 w-10 rounded-full bg-indigo-500 flex-shrink-0">
                                                        <img src={profile1 || 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png'} alt="Avatar" className="h-full w-full rounded-full" />
                                                    </div>
                                                ...
                                                <div className="flex flex-row items-center">
                                                    <div className="flex items-center justify-center h-10 w-10 rounded-full bg-indigo-500 flex-shrink-0">
                                                        <img src={profile2 || 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png'} alt="Avatar" className="h-full w-full rounded-full" />
                                                    </div>
