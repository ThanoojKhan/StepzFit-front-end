                ...
                {[1,2,3,4,5].map((card, index) => (
                    ...
                    >
                        <Text as="h2" className="text-zinc-100 flex items-end gap-0.5">
                            ...
                            <span className={`font-extrabold `}>{card.amount}</span>
                            <span className="font-medium text-lg">/{card.duration}</span>
                        </Text>
                        <Text
                            as="h3"
                            className={`capitalize text-base font-semibold w-full py-2 text-center  text-zinc-100 my-3 ${("12") ? "bg-gradient-to-r to-amber-500 from-red-500" : "bg-zinc-800"
                                }`}
                        >
                            {card.caption}
                        </Text>
