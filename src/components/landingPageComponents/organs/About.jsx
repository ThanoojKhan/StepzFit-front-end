...
const About = () => {
  return (
    <>
      <section className="w-full h-auto flex items-center bg-zinc-950 w3-animate-bottom delay-75">
          ...
          <div className="h-full w-full md:order-1 order-2 flex flex-col justify-center items-start gap-4 pb-8 md:pb-12">
            <Fade>
              <div className="flex flex-col mt-10 items-start relative before:absolute before:-bottom-6 before:left-0 before:w-20 before:h-1 before:rounded-lg z-10">
                <h1 as="h1" className="absolute text-zinc-500/40 md:-left-3 left-0 lg:text-8xl md:text-7xl text-6xl font-light lg:-top-36 md:-top-20 -top-16 -z-10">About StepzFit</h1>
              </div>
              <h1 as="h2" className="text-zinc-200 mt-16 mb-4 font-light text-lg">Meet StepzFit, where fitness meets community and transformation happens!</h1>
              <h1 as="p" className="text-zinc-400 text-justify text-base font-light">At StepzFit, we are more than just a gym; we are a passionate and supportive fitness family dedicated to helping you achieve your health and wellness goals. Our mission is to create a positive and empowering environment that inspires you to challenge yourself, embrace a healthy lifestyle, and discover the best version of yourself.</h1>
            </Fade>
          </div>
