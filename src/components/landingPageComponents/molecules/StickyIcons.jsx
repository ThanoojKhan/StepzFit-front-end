...
const StickyIcons = () => {
    ...
    return (
        <>
            {!isOpen && (
                <button onClick={toggleIcons} className="fixed z-50 lg:bottom-32 bottom-32  left-0 transform rotate-90 text-zinc-100 hover:text-zinc-400 flex flex-col justify-center items-center w3-animate-left delay-75">
