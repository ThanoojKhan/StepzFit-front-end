...
const StickyIcons = () => {
    ...
    return (
        <>
            {!isOpen && ( 
                <button onClick={toggleIcons} className="fixed lg:bottom-32 bottom-1/2 left-0 transform rotate-90 text-zinc-100 hover:text-zinc-400 flex flex-col justify-center items-center">
            ...
            {isOpen ? (
                <aside className={`fixed lg:bottom-0 bottom-1/2 left-0 flex flex-col gap-5 items-center bg-transparent rounded-e-lg py-3 px-2`}>
