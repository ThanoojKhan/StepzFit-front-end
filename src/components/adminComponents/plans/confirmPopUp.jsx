...
const ConfirmPopup = ({ isOpen, onCancel, onConfirm }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-screen z-50 h-screen bg-gray-800 bg-opacity-50 flex justify-center items-center">
      <div className="bg-white w-full max-w-md mx-auto px-6 py-4 rounded shadow-md text-black">
        ...
        <p className="mb-4 text-center">Are you sure you want to delete this plan?</p>
